...
screen = pygame.display.set_mode((1280, 720)) #vytvoří herní okno
clock = pygame.time.Clock() #hlídá FPS
running = True #hlavní herní smyčka


player_x = 50
player_y = 150 #souřadnice hráče
